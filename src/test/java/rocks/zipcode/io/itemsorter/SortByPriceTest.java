...
public class SortByPriceTest {
    ...
    public void test1() {
        // given
        Item item3 = new Item(0L, "Headphones", 1.0);
        Item item2 = new Item(1L, "TV", 2.5);
        Item item1 = new Item(2L, "Laptop", 4.0);
    ...
    public void test2() {
        // given
        Item item3 = new Item(0L, "Pencil", 1.0);
        Item item2 = new Item(1L, "Bic", 1.5);
        Item item1 = new Item(2L, "Pen", 2.0);
        Item[] itemsToSort = {item2, item1, item3};
        Item[] expected = {item3, item2, item1};
        ItemSorter itemSorter = new ItemSorter(itemsToSort);
        Comparator<Item> comparator = (Comparator<Item>) new PriceComparator();
    ...
    public void test3() {
        // given
        Item item3 = new Item(0L, "Milk", 1.0);
        Item item2 = new Item(1L, "Tea", 2.5);
        Item item1 = new Item(2L, "Coffee", 4.0);
        Item[] itemsToSort = {item2, item1, item3};
        Item[] expected = {item3, item2, item1};
        ItemSorter itemSorter = new ItemSorter(itemsToSort);
        Comparator<Item> comparator = (Comparator<Item>) new PriceComparator();
